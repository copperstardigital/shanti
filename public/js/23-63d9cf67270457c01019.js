...
exports['default'] = {
    ...
    created: function created() {
        ...
        axios.get('/search/?keywords=' + this.$route.query.keywords).then(function (response) {
            ...
            _this.posts = reformattedPosts;

            var events = response.data.events;
            var reformattedEvents = [];
            if (_this.$cookie.get('language') === 'es') {
            ...
            _this.events = reformattedEvents;
...
Component.options.__file = "/Users/brianwebb/Development/exponential/clients/shanti/resources/assets/js/views/SearchResults.vue"
