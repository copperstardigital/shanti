...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__bootstrap__ = __webpack_require__(57);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__routes__ = __webpack_require__(58);



Vue.component('psg-header', __webpack_require__(71));
Vue.component('psg-footer', __webpack_require__(70));
Vue.component('psg-page', __webpack_require__(73));
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_vue_simple_lightbox__ = __webpack_require__(79);
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__Nav__ = __webpack_require__(72);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_vee_validate__ = __webpack_require__(69);
...
var router = new __WEBPACK_IMPORTED_MODULE_0_vue_router__["a" /* default */]({
    routes: [{ path: '/', component: Home, meta: { title: 'Home' } }, { path: '/about/cultural-competency', component: CulturalCompetency, meta: { title: 'Cultural Compentency' } }, { path: '/about/history', component: History, meta: { title: 'History' } }, { path: '/about/mission', component: Mission, meta: { title: 'Mission' } }, { path: '/about/privacy-policy', component: PrivacyPolicy, meta: { title: 'Privacy Policy' } }, { path: '/contact/board', component: Board, meta: { title: 'Board of Directors' } }, { path: '/contact/office', component: Office, meta: { title: 'Main Office' } }, { path: '/contact/staff', component: Staff, meta: { title: 'Staff' } }, { path: '/services/housing', component: Housing, meta: { title: 'HIV+ Housing' } }, { path: '/services/hiv', component: Services, meta: { title: 'HIV Services' } }, { path: '/support/donate', component: Donate, meta: { title: 'Donate' } }, { path: '/support/resources', component: Resources, meta: { title: 'Resources' } }, { path: '/support/volunteer', component: Volunteer, meta: { title: 'Volunteer' } },
    // { path: '/about', component: require('./views/About'), meta: { title: 'About'}},
    { path: '/blog', component: Posts, meta: { title: 'Blog' } }, { path: '/blog/30', redirect: '/30' }, { path: '/blog/:slug', name: 'blog/view', component: Post, meta: { title: '' } }, { path: '/events', component: Events, meta: { title: 'Events' } }, { path: '/events/:slug', name: 'event/view', component: Event, meta: { title: '' } }, { path: '/getting-started', component: GettingStarted, meta: { title: 'Getting Started' } }, { path: '/site-map', component: SiteMap, meta: { title: 'Site Map' } }, { path: '/search-results', component: SearchResults, meta: { title: 'Search Results' } }, { path: '/30', component: ThirtiethAnniversary, meta: { title: '30th Anniversary' } }, { path: '*', component: NotFound, meta: { title: 'Page Not Found' } }]
});
