...
Vue.component('psg-header', __webpack_require__(79));
Vue.component('psg-page', __webpack_require__(81));
Vue.component('psg-footer', __webpack_require__(78));
...
var _vueSimpleLightbox = __webpack_require__(87);
...
exports.default = {
    ...
    }), _defineProperty(_computed, 'gallery', function gallery() {
        if (this.$cookie.get('language') === 'es') {
            return 'Galería';
        } else {
            return 'Gallery';
...
var _veeValidate = __webpack_require__(76);

var _veeValidate2 = _interopRequireDefault(_veeValidate);

var _vueCookie = __webpack_require__(77);
